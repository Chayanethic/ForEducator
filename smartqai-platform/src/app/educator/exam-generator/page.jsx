  ...
  return (
    <div className="flex h-screen bg-slate-50 font-sans selection:bg-indigo-100 selection:text-indigo-900 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col relative overflow-hidden">
        ...
        {/* Header Area */}
        <header className="relative z-20 px-8 py-6 flex justify-between items-center max-w-[1400px] w-full mx-auto">
          <div className="flex items-center gap-4">
            <div className="md:hidden">
              <button className="w-10 h-10 bg-white text-slate-600 rounded-full flex items-center justify-center shadow-sm border border-slate-200">
                ...
                {examStep === 2 && generatedExam && (
                  <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div className="bg-white rounded-[2rem] p-6 shadow-lg border border-slate-200 mb-6">
                      ...
                      <button onClick={() => setExamStep(1)} className="w-full mt-4 text-xs font-bold text-slate-400 hover:text-rose-500 transition">
                        Discard & Start Over
                      </button>
                    </div>
                  </div>
